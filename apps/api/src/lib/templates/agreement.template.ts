...
<head>
  ...
  <title>Tenancy Agreement — BeyondAgency</title>
  <style>
...
<body>
  ...
  <div class="header">
    <div class="logo">BEYONDAGENCY</div>
  ...
  <div class="section">
    ...
    <div class="clause">
      ...
      agreement shall first be referred to mediation through the BeyondAgency platform. If unresolved,
  ...
  <div class="lawyer-badge">
    ✓ This agreement has been reviewed and verified by a BeyondAgency-certified legal practitioner
  </div>
  ` : ''}
  ...
  <div class="section">
    ...
    <p style="font-size: 10pt; color: #718096; margin-bottom: 24px;">
      By proceeding with payment on the BeyondAgency platform, both parties confirm their acceptance
  ...
  <div class="footer">
    This agreement was generated by BeyondAgency (leja.ng) — Nigeria's trust platform for direct deals.
  ...
  <div class="watermark-verified">BEYONDAGENCY</div>
